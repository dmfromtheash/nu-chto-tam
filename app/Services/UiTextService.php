...
final class UiTextService
{
    ...
    private static function registry(): array
    {
        return [
            ...
            ['key' => 'home.hero.eyebrow', 'group' => 'Главная', 'label' => 'Hero: верхняя подпись', 'default' => 'Витрина паков для обычных дней', 'type' => 'input'],
            ['key' => 'home.hero.title', 'group' => 'Главная', 'label' => 'Hero: заголовок', 'default' => 'Ну что там?', 'type' => 'input'],
            ['key' => 'home.hero.lead', 'group' => 'Главная', 'label' => 'Hero: основной текст', 'default' => 'Выбери пак на витрине, перейди в сцену открытия и вытяни карту: иногда это шутка, иногда — очень вовремя.', 'type' => 'textarea'],
            ...
            ['key' => 'home.hero.choose_button', 'group' => 'Главная', 'label' => 'Кнопка выбора пака', 'default' => 'К стартовым пакам', 'type' => 'input'],
            ['key' => 'home.hero.random_button', 'group' => 'Главная', 'label' => 'Кнопка случайного пака', 'default' => 'Случайный пак', 'type' => 'input'],
            ['key' => 'home.pack_nav.eyebrow', 'group' => 'Главная', 'label' => 'Навигация паков: верхняя подпись', 'default' => 'Навигация', 'type' => 'input'],
            ['key' => 'home.pack_nav.title', 'group' => 'Главная', 'label' => 'Навигация паков: заголовок', 'default' => 'Разделы паков', 'type' => 'input'],
            ['key' => 'home.pack_nav.note', 'group' => 'Главная', 'label' => 'Навигация паков: пояснение', 'default' => 'Быстрый переход по витрине.', 'type' => 'textarea'],
            ['key' => 'home.pack_nav.aria', 'group' => 'Главная', 'label' => 'Навигация паков: aria-label', 'default' => 'Разделы паков', 'type' => 'input'],
            ['key' => 'home.featured.eyebrow', 'group' => 'Главная', 'label' => 'Featured: верхняя подпись', 'default' => 'Витрина', 'type' => 'input'],
            ['key' => 'home.featured.title', 'group' => 'Главная', 'label' => 'Featured: заголовок', 'default' => 'Стартовые паки', 'type' => 'input'],
            ['key' => 'home.featured.note', 'group' => 'Главная', 'label' => 'Featured: пояснение', 'default' => 'Выбери один из трёх входов: дальше откроется отдельная сцена и первая карта.', 'type' => 'textarea'],
            ['key' => 'home.featured.loading', 'group' => 'Главная', 'label' => 'Featured: загрузка', 'default' => 'Подбираю стартовые паки для первой сцены.', 'type' => 'textarea'],
            ...
            ['key' => 'home.packs.note', 'group' => 'Главная', 'label' => 'Коллекция: пояснение', 'default' => 'Остальные сценарии ниже: короткие, большие, вопросные и для друзей.', 'type' => 'textarea'],
