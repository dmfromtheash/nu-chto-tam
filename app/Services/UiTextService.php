...
final class UiTextService
{
    ...
    private static function registry(): array
    {
        return [
            ...
            ['key' => 'home.featured.note', 'group' => 'Главная', 'label' => 'Featured: пояснение', 'default' => 'Три понятных входа: быстро на день, шире на период и честно про внутренний вайб.', 'type' => 'textarea'],
            ['key' => 'home.featured.loading', 'group' => 'Главная', 'label' => 'Featured: загрузка', 'default' => 'Подбираю три пака для старта.', 'type' => 'textarea'],
